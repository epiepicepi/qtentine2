...
function TimelineItem({ date, title, text, gif }) {
  ...
  return (
    <div className="relative pl-14">
      ...
      {/* Card */}
      <div className="bg-white/80 backdrop-blur rounded-3xl shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 p-6 flex flex-col md:flex-row gap-6">
...
export default function Timeline() {
  ...
  // 💖 6 October 2022, 1:04 AM IST (UTC+05:30)
  const startDate = new Date("2022-10-06T01:04:00+05:30");
 ...
 const events = [
    ...
    },
    {
      ...
      gif: "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExejNndnJibGMyam15MTBxdHJmeXl0YXpkY3gyangyamUwbGZ4N2s3NyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/jnEbIEVqWxY1W/giphy.gif",
    },
        {
      date: "13 May 2023",
      ...
      title: "A day out at Salim Ali bird santuary 🐦",
        ...
        <div className="text-center mt-24 flex flex-col items-center gap-6">
          ...
          {timeElapsed && (
            <div className="flex flex-wrap justify-center gap-4 mt-4">
              ...
              <CounterCard value={timeElapsed.hours} label="Hours" />
              <CounterCard value={timeElapsed.minutes} label="Minutes" />
              <CounterCard value={timeElapsed.seconds} label="Seconds" />
            </div>
          )}
